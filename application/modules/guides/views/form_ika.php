			...
			<div class="container mt-10">
				<div class="card">
					<div class="card-header py-">
						<h3 class="card-title m-0">New File IKA</h3>
					</div>
					...
					<div class="card-body">
						<div class="row">
							<div class="col-md-6">
								...
								<div class="row mb-3">
									<label class="col-4 col-form-label">Nama IK <span class="text-danger">*</span></label>
									<div class="col-8">
										<input type="text" name="name" id="name" placeholder="Nama IK" class="form-control">
									</div>
								</div>
						...
						<ul class="nav nav-tabs nav-fill nav-success nav-pills mb-3 border-0" id="myTab" role="tablist">
							...
							<li class="nav-item" role="presentation">
								<button class="nav-link font-weight-bolder w-100" id="CMC-tab" data-toggle="tab" data-target="#CMC" type="button" role="tab" aria-controls="CMC" aria-selected="false">IK Lainnya</button>
							</li>
