											...
											<div class="card-body">
												...
												<div class="row">
													<div class="col-md-6">
														...
														<div class="form-group">
															<label class="font-size-h5"><strong><span class="text-danger">*</span> Objektif Proses (Tujuan)</strong></label>
															<div class="">
													...
													<div class="col-md-12">
														<div class="form-group">
															...
															<div class="">
																<textarea name="acuan" rows="5" id="acuan" class="form-control summernote" placeholder="Acuan" aria-describedby="helpId"><?= $data->acuan; ?></textarea>
